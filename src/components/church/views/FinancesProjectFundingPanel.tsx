      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#EAE1D7] flex flex-col gap-5">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="space-y-1">
            ...
            <h2 className="font-headline text-2xl font-bold text-[#1e1b19]">
              Grace Valley Sanctuary Renovation & Youth Annex Expansion
            </h2>
          ...
          <div className="flex flex-col items-start md:items-end shrink-0 bg-[#faf2ee] p-4 rounded-xl border border-[#EAE1D7]">
            ...
            <span className="font-headline text-2xl font-extrabold text-[#1e1b19]">$850,000</span>
            <span className="text-xs text-[#006243] font-bold mt-0.5">
              $637,500 Raised & Pledged (75.0%)
            </span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="w-full bg-[#EAE1D7] h-3.5 rounded-full overflow-hidden flex">
            {/* Cash in escrow: 61.2% */}
            <div className="bg-[#9b2f00] h-full" style={{ width: '61.2%' }} title="Cash in Escrow: $520,200"></div>
            {/* Signed Pledges: 13.8% */}
            <div className="bg-[#fe932c] h-full" style={{ width: '13.8%' }} title="Signed Pledges: $117,300"></div>
          </div>
        ...
        <div className="pt-4 border-t border-[#f4ece8]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div className="p-3 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] flex flex-col justify-between">
              ...
              <div className="text-[11px] text-[#59413a] font-mono mt-1">$45,000 Settled</div>
            </div>
            ...
            <div className="p-3 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] flex flex-col justify-between">
              ...
              <div className="text-[11px] text-[#59413a] font-mono mt-1">$180,000 Settled</div>
            </div>
            ...
            <div className="p-3 bg-[#ffdcc3]/30 rounded-xl border border-[#fe932c]/40 flex flex-col justify-between">
              ...
              <div className="text-[11px] text-[#904d00] font-mono mt-1">65% ($220,000)</div>
            </div>
            ...
            <div className="p-3 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] flex flex-col justify-between">
              ...
              <div className="text-[11px] text-[#59413a] font-mono mt-1">$260,000 Budgeted</div>
            </div>
            ...
            <div className="p-3 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] flex flex-col justify-between">
              ...
              <div className="text-[11px] text-[#59413a] font-mono mt-1">$145,000 Final</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-5 rounded-2xl bg-white shadow-sm border border-[#EAE1D7] space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3.5 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#9b2f00] text-[20px]">directions_bus</span>
                  <span className="font-semibold text-xs text-[#1e1b19]">Church Van Transport Fund</span>
                </div>
                <span className="font-headline font-bold text-xs text-[#1e1b19]">$42,000 / $55,000</span>
              </div>
              ...
              <div className="flex justify-between text-[10px] font-mono text-[#59413a]">
                <span>76% Funded</span>
                <span>$13,000 to purchase 15-passenger van</span>
              </div>
            </div>
            ...
            <div className="p-3.5 bg-[#faf2ee] rounded-xl border border-[#EAE1D7] space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#904d00] text-[20px]">music_note</span>
                  <span className="font-semibold text-xs text-[#1e1b19]">Pipe Organ Restoration Fund</span>
                </div>
                <span className="font-headline font-bold text-xs text-[#1e1b19]">$18,500 / $25,000</span>
              </div>
              <div className="w-full bg-[#EAE1D7] h-2 rounded-full overflow-hidden">
                ...
                <div key={idx} className="p-2.5 rounded-xl bg-[#faf2ee] border border-[#EAE1D7] flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-[11px] text-[#59413a]">
                      ${p.fulfilled.toLocaleString()} fulfilled of ${p.pledged.toLocaleString()}
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in zoom-in-95">
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <input type="text" placeholder="e.g. Deaconess Clara Oswald" className="w-full h-9 px-3 rounded-xl bg-[#faf2ee] border border-[#EAE1D7]" />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold mb-1">Pledge Amount ($)</label>
                  <input type="number" placeholder="10,000" className="w-full h-9 px-3 rounded-xl bg-[#faf2ee] border border-[#EAE1D7]" />
                </div>
                <div>
