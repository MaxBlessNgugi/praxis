...
export const ReportsCertsView: React.FC = () => {
  ...
  const [candidateName, setCandidateName] = useState('Caleb Timothy Vance (#091 • Covenant Youth)');
  const [candidateDisplayName, setCandidateDisplayName] = useState('Caleb Timothy Vance');
  const [officiatingMinister, setOfficiatingMinister] = useState('Pastor Michael Vance (Senior Pastor)');
  ...
  const handleCertTabChange = (type: CertificateType) => {
    ...
    if (type === 'baptism') {
      setCandidateName('Caleb Timothy Vance (#091 • Covenant Youth)');
      ...
      setCandidateName('David Alistair & Ruth Harrison');
      setCandidateDisplayName('David Alistair & Ruth Harrison');
      ...
      setCandidateName('Lucas Montgomery (#144 • Catechumen)');
      ...
      <div className="pt-2 pb-4 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-[#f4ece8] text-[#59413a] text-[11px] font-semibold tracking-wider uppercase">
            ...
            Ecclesiastical Documentation & Archives • Q4 Audit Compliant
          </div>
          ...
          <p className="text-sm text-[#59413a] max-w-2xl">
            Official parish document generation, sacramental certificates registry, and Annual General Meeting (AGM) legislative compilations.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button 
            type="button"
            onClick={() => showToast("Opening Ecclesiastical Archive Vault: 142 historical dossiers indexed.")}
          ...
          >
            <span className="material-symbols-outlined text-[19px] text-[#904d00]">inventory_2</span>
            <span>Archive Vault (142)</span>
          </button>
          <button 
            type="button"
            onClick={() => showToast("Launching Custom Document Wizard for parish clerk...")}
        ...
        <div className="p-4 rounded-xl bg-white shadow-[0_1px_3px_rgba(28,25,23,0.04),0_4px_12px_rgba(194,65,12,0.02)] border border-[#e1bfb5]/40 flex items-center gap-3.5">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-xs text-[#59413a]">Sacramental Formats</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(28,25,23,0.04),0_4px_12px_rgba(194,65,12,0.02)] border border-[#e1bfb5]/40 flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#f4ece8] text-[#59413a] text-xs font-semibold self-start border border-[#e1bfb5]/50">
              <span className="material-symbols-outlined text-[15px] text-[#006243]">lock</span>
              <span>Presbytery Ledger v4.2</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 rounded-xl bg-[#faf2ee] border border-[#e1bfb5]/30">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select 
                  ...
                  className="w-full h-10 px-3 pr-8 rounded-lg bg-white text-xs font-medium text-[#1e1b19] appearance-none focus:outline-none focus:ring-1 focus:ring-[#c2410c] shadow-sm cursor-pointer border border-[#e1bfb5]/50"
                >
                  ...
                  <option>Presbytery & Pastoral Secretariat</option>
                </select>
                <span className="material-symbols-outlined pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">expand_more</span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <span className="material-symbols-outlined pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">calendar_month</span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <span className="material-symbols-outlined pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">balance</span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <span className="material-symbols-outlined pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">file_download</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
              <label className="inline-flex items-center gap-2 cursor-pointer text-xs font-medium text-[#1e1b19] select-none">
                <input 
                  ...
                  className="w-4 h-4 rounded text-[#c2410c] focus:ring-0 cursor-pointer accent-[#c2410c]" 
                />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <button 
                type="button"
                onClick={() => showToast("Automated monthly schedule enabled for Presbytery finance committee.")}
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(28,25,23,0.04),0_4px_12px_rgba(194,65,12,0.02)] border border-[#e1bfb5]/40 flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="font-headline text-xl sm:text-2xl text-[#1e1b19] font-bold tracking-tight">
                  Sacramental Certificates Hub
                </h2>
                <p className="text-xs sm:text-sm text-[#59413a] mt-0.5">
                  Issue, authenticate, and register formal liturgical certificates with pastoral seals and watermarks.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1">
            ...
            >
              ...
              <span>Baby Dedication & Child Presentation</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span>Confirmation & Catechumenate</span>
            </button>
          </div>
            ...
            <div className="xl:col-span-5 space-y-4">
              <div className="p-5 rounded-xl bg-[#faf2ee] border border-[#e1bfb5]/40 space-y-4">
                <h3 className="text-sm font-headline text-[#1e1b19] font-bold flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#c2410c] text-[20px]">edit_document</span>
                  <span>Sacramental Record Details</span>
                </h3>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    />
                    <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">person_search</span>
                    <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-[#006243] text-[18px]">verified</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <select 
                      ...
                      className="w-full h-10 px-3 pr-8 rounded-lg bg-white text-xs font-medium text-[#1e1b19] appearance-none shadow-sm border border-[#e1bfb5]/50 focus:outline-none focus:ring-1 focus:ring-[#c2410c] cursor-pointer"
                    >
                      <option>Pastor Michael Vance (Senior Pastor)</option>
                      <option>Rev. Sharon Miller (Associate Pastor)</option>
                      <option>Elder Marcus Jenkins (Session Clerk)</option>
                    </select>
                    <span className="material-symbols-outlined pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">expand_more</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    />
                    <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">event</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full p-2.5 rounded-lg bg-white text-xs font-medium text-[#1e1b19] shadow-sm border border-[#e1bfb5]/50 focus:outline-none focus:ring-1 focus:ring-[#c2410c] leading-relaxed resize-none" 
                  />
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full h-10 px-3 pr-7 rounded-lg bg-white text-xs font-medium text-[#1e1b19] appearance-none shadow-sm border border-[#e1bfb5]/50 focus:outline-none focus:ring-1 focus:ring-[#c2410c] cursor-pointer"
                      >
                        <option>Embossed Gold Seal</option>
                        <option>Terracotta Parish Stamp</option>
                        <option>Ecclesiastical Wax Mark</option>
                      </select>
                      <span className="material-symbols-outlined pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-[#59413a] text-[18px]">expand_more</span>
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-[#59413a] font-headline">Parish Roll No.</label>
                    <input 
                      type="text" 
                      readOnly 
                      value={parishRollNo}
              ...
              <div className="relative w-full rounded-2xl bg-[#faf6f0] p-6 sm:p-10 shadow-[0_8px_30px_rgba(28,25,23,0.08)] border border-[#d8c7b8] overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center space-y-4 my-2">
                  ...
                  <p className="text-[11px] font-headline uppercase tracking-widest text-[#786b62] -mt-2">
                    Diocese of the Pacific • General Session Roll #2024
                  </p>
                  ...
                  <div className="py-1">
                    <h3 className="font-serif italic text-2xl sm:text-3xl text-[#2b1810] tracking-tight font-bold">
                      ...
                      {activeCertTab === 'confirmation' && 'Certificate of Catechumenal Confirmation'}
                    </h3>
                  ...
                  <p className="text-xs sm:text-sm text-[#59413a] max-w-lg leading-relaxed pt-1">
                    ...
                    {activeCertTab === 'dedication' && 'was solemnly dedicated unto the Lord with prayer and covenant vows by faithful parents and parish sponsors.'}
                    {activeCertTab === 'matrimony' && 'were united in the holy covenant of Christian marriage according to the ordinance of God and the canonical Book of Order.'}
                    {activeCertTab === 'confirmation' && 'having completed the Berean Catechumenate and examined by the Session, is received as a full communicant member.'}
                  </p>
                  ...
                  <div className="w-full grid grid-cols-3 items-end pt-4 mt-2">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="font-serif italic text-sm text-[#1e1b19] leading-tight font-bold">
                        {officiatingMinister.split('(')[0]?.trim() || 'Pastor Michael Vance'}
                      </div>
                      <div className="w-28 h-[1px] bg-[#a8998d] my-1"></div>
                      <span className="text-[10px] text-[#786b62] uppercase tracking-wider font-semibold">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(28,25,23,0.04),0_4px_12px_rgba(194,65,12,0.02)] border border-[#e1bfb5]/40 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <p className="text-xs text-[#59413a] mt-0.5">
                  5 of 6 constituent chapters fully ratified by Presbytery Executive Committee.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
            ...
            <div className="p-4 rounded-xl bg-[#faf2ee]/80 border border-[#e1bfb5]/30 flex flex-col justify-between gap-3 hover:bg-[#faf2ee] transition-colors">
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="material-symbols-outlined text-[18px] text-[#006243]">check_circle</span>
              </div>
            ...
            <div className="p-4 rounded-xl bg-[#ffdcc3]/20 border border-[#ffdcc3]/60 flex flex-col justify-between gap-3 hover:bg-[#ffdcc3]/30 transition-colors">
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="material-symbols-outlined text-[18px] text-[#904d00]">pending</span>
              </div>
              <div className="flex items-center justify-between text-xs text-[#59413a] pt-1 border-t border-[#ffdcc3]/40">
                <span>Pending Presbytery Vote</span>
          ...
          <div className="p-4 rounded-xl bg-[#faf2ee] border border-[#e1bfb5]/30 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[18px] text-[#59413a]">palette</span>
                ...
                >
                  ...
                  <option>Modern Liturgical Monogram</option>
                  <option>Grace Valley Architectural Elevation</option>
                </select>
              </div>
              ...
              <label className="inline-flex items-center gap-2 cursor-pointer select-none text-xs font-medium text-[#1e1b19]">
                <input 
                  ...
                  className="w-4 h-4 rounded text-[#c2410c] accent-[#c2410c]" 
                />
                <span>Governance Appendix & By-laws</span>
              </label>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 pt-2">
            ...
            <button 
              type="button"
              onClick={() => showToast("Digital proof securely dispatched to Presbytery Council email ledger.")}
            ...
            >
              ...
              <span>Send Digital Proof to Presbytery Council</span>
            </button>
          </div>
        </div>
      </div>
