      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="p-4 rounded-[12px] bg-[#FDF8F3] border border-[#E7E5E4] space-y-4">
          <div className="flex items-center justify-between">
            ...
            <input aria-label="SMS text message carrier gateway"
              type="checkbox"
        ...
        <div className="p-4 rounded-[12px] bg-[#FDF8F3] border border-[#E7E5E4] space-y-4">
          <div className="flex items-center justify-between">
            ...
            <input aria-label="Email broadcast engine"
              type="checkbox"
            ...
            <label className="flex items-center justify-between p-3 rounded-[10px] bg-[#FDF8F3] border border-[#E7E5E4] cursor-pointer hover:bg-[#F5EDE4]/50">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[#57534E]">Immediately email official PDF receipt upon recording contributions.</div>
                </div>
              </div>
              <input
                type="checkbox"
