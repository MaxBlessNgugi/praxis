...
export const BroadcastsPanel: React.FC = () => {
  ...
  const [targetAudience, setTargetAudience] = useState<string>('All Covenant Partners & Regular Attenders (342 recipients)');
  const [senderName, setSenderName] = useState<string>('Parish Office (Carolyn Wright)');
  ...
  const handleSendBroadcast = (e: React.FormEvent) => {
    ...
    const newBroadcast: BroadcastItem = {
      id: `bc-${Date.now()}`,
      channel,
      subject: channel === 'email' ? subject || 'Parish Dispatch' : undefined,
      messageBody,
      targetAudience,
      totalRecipients: 342,
      sentCount: 342,
          ...
          <div className="bg-[#FFFFFF] rounded-[14px] p-4 border border-[#E7E5E4] shadow-warm-card">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-headline text-sm font-bold text-[#1C1917] flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[18px] text-[#C2410C]">bookmark</span>
                Message Templates
              </h3>
            ...
            <p className="text-xs text-[#57534E] mb-3">
              Pre-approved canonical copy with dynamic variable interpolation.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#E7E5E4] mb-4">
              <div>
                <h3 className="font-headline text-base font-bold text-[#1C1917] flex items-center gap-2">
                  <span className="material-symbols-outlined text-[20px] text-[#C2410C]">outbox</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-xs rounded-[8px] border border-[#E7E5E4] focus:outline-none focus:border-[#C2410C] bg-[#FDF8F3]"
                  >
                    <option value="All Covenant Partners & Regular Attenders (342 recipients)">
                      All Members & Attenders (342)
                    </option>
                    <option value="Worship Band & AV Volunteer Roster (24 recipients)">
                      Worship & Sound Team (24)
                    </option>
                    <option value="Deaconate & Elder Prayer Intercessors (16 recipients)">
                      Elders & Deacons (16)
                    </option>
              ...
              {channel === 'email' && (
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Grace Valley Parish Herald: Sunday Liturgy & Fellowship"
                    value={subject}
